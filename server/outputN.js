const dropdowns = {
  1: {
    Subject: [{ value: "Kreol Rodrige", label: "Kreol Rodrige" }],
    Grade: [{ value: "1", label: "1" }],
    Theme: [
    ...
    "Targets/Activities": [
      ...
      {
        value:
          "Aktivite 1. Ki mo aprãnn dan Grad 1?  Ki mo aprãnn dan klas KR?",
        label:
          "Aktivite 1. Ki mo aprãnn dan Grad 1?  Ki mo aprãnn dan klas KR?",
      },
      {
      ...
      {
        value: "Aktivite 2. Mo met let ‘e’ dan sa text-la lor tou bãnn tire",
        label: "Aktivite 2. Mo met let ‘e’ dan sa text-la lor tou bãnn tire",
      },
      {
      ...
      {
        value: "Aktivite 2. Mo met ‘’ou’’ dan sa text-la lor tou bãnn tire:",
        label: "Aktivite 2. Mo met ‘’ou’’ dan sa text-la lor tou bãnn tire:",
      },
      {
      ...
      {
        value:
          "Aktivite 2. Mo ekoute. Mo anserkle bãnn mo kot mo tãnn son [ou].",
        label:
          "Aktivite 2. Mo ekoute. Mo anserkle bãnn mo kot mo tãnn son [ou].",
      },
      {
    ...
    Pages: [
      ...
      { value: "21 to 42", label: "21 to 42" },
      { value: "43 to 66", label: "43 to 66" },
      { value: "67 to 86", label: "67 to 86" },
      { value: "1 to 36", label: "1 to 36" },
      { value: "37 to 70", label: "37 to 70" },
      { value: "71 to 93", label: "71 to 93" },
    ],
    Texbook: [
  ...
  2: {
    ...
    "Targets/Activities": [
      ...
      {
        value:
          "1. Mo lir sa bãnn silab-la. Mo dir enn mo kot mo tãnn sak silab.",
        label:
          "1. Mo lir sa bãnn silab-la. Mo dir enn mo kot mo tãnn sak silab.",
      },
    ],
    ...
    Pages: [
      { value: "Paz 2-5", label: "Paz 2-5" },
      { value: "Paz 6-9", label: "Paz 6-9" },
      { value: "Paz 10-11", label: "Paz 10-11" },
      { value: "Paz 12-14", label: "Paz 12-14" },
      { value: "Paz 15", label: "Paz 15" },
      { value: "Paz 16-19", label: "Paz 16-19" },
      { value: "Paz 20-22", label: "Paz 20-22" },
      { value: "Paz 23-25", label: "Paz 23-25" },
      { value: "Paz 26-27", label: "Paz 26-27" },
      { value: "Paz 28-29", label: "Paz 28-29" },
      { value: "Paz 31 -35", label: "Paz 31 -35" },
      { value: "Paz 36-38", label: "Paz 36-38" },
      { value: "Paz 39", label: "Paz 39" },
      { value: "Paz 40-45", label: "Paz 40-45" },
      { value: "Paz 46-48", label: "Paz 46-48" },
      { value: "Paz 49-51", label: "Paz 49-51" },
      { value: "Paz 52-54", label: "Paz 52-54" },
      { value: "Paz 55-57", label: "Paz 55-57" },
      { value: "Paz 58-59", label: "Paz 58-59" },
      { value: "Paz 62-65", label: "Paz 62-65" },
      { value: "Paz 66-69", label: "Paz 66-69" },
      { value: "Paz 70-71", label: "Paz 70-71" },
      { value: "Paz 72-83", label: "Paz 72-83" },
      { value: "Paz 84", label: "Paz 84" },
      { value: "Paz 85", label: "Paz 85" },
      { value: "Paz 86-87", label: "Paz 86-87" },
      { value: "Paz 88-90", label: "Paz 88-90" },
    ],
    Texbook: [
      { value: "Volim 1", label: "Volim 1" },
      { value: "Volim 2", label: "Volim 2" },
  ...
  3: {
    ...
    "Targets/Activities": [
      ...
      {
        value:
          "1. Dekoup sa bãnn mo-la an silab ek mo ekrir zot an Madanm Sere",
        label:
          "1. Dekoup sa bãnn mo-la an silab ek mo ekrir zot an Madanm Sere",
      },
      {
      ...
      {
        value: "7. Kolorye repons ki bon.",
        label: "7. Kolorye repons ki bon.",
      },
      {
    ...
    Strands: [],
    Pages: [
      { value: "paz 1 - 16", label: "paz 1 - 16" },
      { value: "paz 17 - 40", label: "paz 17 - 40" },
      { value: "paz 41 - 60", label: "paz 41 - 60" },
      { value: "paz 61 - 79", label: "paz 61 - 79" },
      { value: "paz 1 - 18", label: "paz 1 - 18" },
      { value: "paz 19 - 44", label: "paz 19 - 44" },
      { value: "paz 45 - 72", label: "paz 45 - 72" },
      { value: "paz 73 - 89", label: "paz 73 - 89" },
    ],
    Texbook: [
      { value: "Volim 1", label: "Volim 1" },
      { value: "Volim 2", label: "Volim 2" },
  ...
  4: {
    ...
    "Topics/Objectives": [
      ...
      {
        value: "Pran laparol pou kominike",
        label: "Pran laparol pou kominike",
      },
      {
      ...
      {
        value: "Servi bãnn mo interogatif",
        label: "Servi bãnn mo interogatif",
      },
    ...
    Pages: [
      { value: "1 to 20", label: "1 to 20" },
      { value: "21 to 34", label: "21 to 34" },
      { value: "35 to 66", label: "35 to 66" },
      { value: "67 to 76", label: "67 to 76" },
      { value: "1 to 24", label: "1 to 24" },
      { value: "25 to 44", label: "25 to 44" },
      { value: "45 to 82", label: "45 to 82" },
    ],
    Texbook: [
      { value: "Volim 1", label: "Volim 1" },
      { value: "Volim 2", label: "Volim 2" },
  ...
  5: {
    Subject: [{ value: "Kreol Rodrige", label: "Kreol Rodrige" }],
    Grade: [{ value: "Grade 5", label: "Grade 5" }],
    Themes: [
      { value: "Sapit 1-Lamitie", label: "Sapit 1-Lamitie" },
      { value: "Sapit 2| Spor", label: "Sapit 2| Spor" },
      { value: "Sapit 3 | Zwazo", label: "Sapit 3 | Zwazo" },
      { value: "Sapit 4 | Lasante", label: "Sapit 4 | Lasante" },
      { value: "Sapit 5| Lafami", label: "Sapit 5| Lafami" },
      { value: "Sapit 6| Mwayin transpor", label: "Sapit 6| Mwayin transpor" },
      { value: "Sapit 7| Evaliasion", label: "Sapit 7| Evaliasion" },
    ],
    Topics: [
      ...
      {
        value: "Ribrik 6: Prodiksion ekri",
        label: "Ribrik 6: Prodiksion ekri",
      },
    ...
    Reference: [
      { value: "Paz 1 – 22", label: "Paz 1 – 22" },
      { value: "Paz 23 – 44", label: "Paz 23 – 44" },
      { value: "Paz 45 – 70", label: "Paz 45 – 70" },
      { value: "Paz 71 – 102", label: "Paz 71 – 102" },
      { value: "Paz 45 – 97", label: "Paz 45 – 97" },
    ],
    Manuel: [
  ...
  6: {
    Subject: [{ value: "Kreol Rodrige", label: "Kreol Rodrige" }],
    Grade: [{ value: "Grade 6", label: "Grade 6" }],
    Theme: [
      ...
      {
        value: "Bãnn santiman ek lemosion",
        label: "Bãnn santiman ek lemosion",
      },
    ],
    "Topics/Objectives": [
      {
    ...
    Pages: [
      { value: "1 to 52", label: "1 to 52" },
      { value: "53 to 108", label: "53 to 108" },
      { value: "1 to 44", label: "1 to 44" },
      { value: "45 to 104", label: "45 to 104" },
    ],
    Texbook: [
      { value: "Volim 1", label: "Volim 1" },
      { value: "Volim 2", label: "Volim 2" },
...
const textbooks = { 1: [], 2: [], 3: [], 4: [], 5: [], 6: [] };
for (let index = 0; index < Object.keys(dropdowns).length; index++) {
  textbooks[index + 1] = dropdowns[index + 1].Texbook;
}
...
fs.appendFileSync(
  ...
  `
   ...
   const textbooks2 = ${JSON.stringify(textbooks)};`
);
