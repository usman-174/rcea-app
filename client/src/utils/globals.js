...
const topicsBySubject={
  "Kreol Rodrige": [
    ...
    "L, l",
    "L, l",
    "Bann mo pou salitasion ek polites.",
    "Silab kot nou trouv son [l]",
    "Fraz",
    "Evaliasion",
    "Sirandãnn",
    "Lavi!",
    " Nouvo lanin, nouvo klas",
    " Nouvo lanin, nouvo klas",
    " Nouvo lanin, nouvo klas",
    " Nouvo lanin, nouvo klas",
    " “Enn ti moustik”",
    ...
    "Evaliasion",
    "Evaliasion",
    " Fabrik enn kart idantite  Sirandãnn",
    " Fabrik enn kart idantite  Sirandãnn",
    " Fabrik enn kart idantite  Sirandãnn",
    " Fabrik enn kart idantite  Sirandãnn",
    "Enn lazournin difisil",
    " Enn nouvo kamarad",
    " Enn nouvo kamarad",
    " Enn nouvo kamarad",
    " Enn nouvo kamarad",
    " Enn nouvo kamarad",
    " “Jonathan enn ti-garson tirbilan”",
    " “Jonathan enn ti-garson tirbilan”",
    " “Jonathan enn ti-garson tirbilan”",
    " “Jonathan enn ti-garson tirbilan”",
    " Son [ã] Let /an/",
    ...
    "Konpreansion",
    "Konpreansion",
    "Lir ek konpran enn zistwār plizoumwin long",
    "Pran laparol pou kominike",
    "Manifeste enn familiarite avek diferan tip text",
    "Rekonet ek prodir enn fraz sinp",
    "Idantifie son ‘n’ ek ‘nn’",
    "Idantifie son ‘on’ ek ‘onn’",
    "Idantifie ek konpran kronolozi enn zistwār",
    "Servi bann mo",
    "Ekout enn zistwār avek atansion",
    "Pran laparol pou kominike",
    "Diferansie ant form long ek form kourt bãnn verb",
    "Konpran fenomenn diplikasion verb",
    "Devlop konpetans pou servi diksioner",
    "Anplway bãnn sign ponktiasion avek pertinans",
    "Idantifie son “wa”",
    "Devlop kapasite pou lir diferan tip text: poem ek lafis",
    "Ekout enn zistwār avek atansion",
    "Pran laparol pou kominike",
    "Anplway bãnn sign ponktiasion avek pertinans",
    "Servi dan enn fason apropriye “x/ks/gz”",
    "Rekonet enn klas mo: pronom",
    "Rekonet enn klas mo: determinan ",
    "Rekonet bãnn eleman dan enn lantre diksioner",
    "Devlop kapasite memorizasion",
    "Aprãnn poz enn kestion ouver",
    "Servi dan enn fason apropriye “i”, “y”",
    "Rekonet bãnn mo singilie ek pliryel",
    "Klasifie bãnn mo selon bãnn tem",
    "Konpran kronolozi enn text: reper bãnn konekter letan",
    "Lir ek konpran enn zistwār plizoumwin long",
    "Group nominal",
    "Anplway bãnn sign ponktiasion avek pertinans",
    "Servi dan enn fason apropriye “ch” ek ‘’gn’",
    "Aprãnn fer enn deskripsion",
    "Aprãnn fer enn deskripsion",
    "Servi vokabiler pou dekrir enn landrwa ek diferan pārti enn volkan",
    "Servi konpleman obze dan enn fraz",
    "Dekouver enn lafis piblisite",
    "Ekrir enn poskārt",
    "Lir ek konpran enn zistwār plizoumwin long",
    "Idantifie Group Nominal dan enn fraz",
    "Idantifie Group Verbal dan enn fraz ",
    "Servi vokabiler presi pou dekrir enn landrwa",
    "Lir ek ekrir ler",
    "Servi konpleman obze dan enn fraz",
    "Idantifie son [µ]",
    "Itiliz mārker preverbal pou mārk letan bãnn verb",
    "Servi vokabiler presi pou dekrir diferan pārti enn volkan",
    "Dekouver enn lafis piblisite ",
    "Ekrir enn poskārt",
    "Lir ek konpran enn long zistwār ",
    "Rekonet enn fraz ki dan  form diskour direk",
    "Transformasion fraz: diskour direk-diskour indirek",
    "Rekonet enn fraz inzonktif ",
    "Diferansie ant bãnn diferan tip ek form fraz",
    "Tredinion dan bãnn mo",
    "Servi bãnn mo interogatif ",
    "Kas-tet",
    "Not available",
    "Ribrik 1: Oral",
    "Ribrik 2: Konpreansion",
    "Ribrik 3: Vokabiler",
    "Ribrik 4: Lortograf",
    "Ribrik 5: Gramer",
    "Ribrik 5: Gramer",
    "Ribrik 6: Prodiksion ekri",
    "Ribrik 7: Lektir",
    "Ribrik 1: Oral",
    "Ribrik 2: Konpreansion",
    "Ribrik 3: Vokabiler",
    ...
    "Lekritir",
    "Vokabiler",
    "Li ek konpran enn text ki long",
    "Reper enn azektif parmi enn group mo, dan enn fraz ek dan enn text",
    "Servi azektif dan enn fraz",
    "Devlop enn vokabiler presi pou tem metie",
    "Konin kan servi \"x\", \"ks\", \"gz\", \"on\" ek \"onn\" dan lekritir mo",
    "Aplik sekans kronolozik dan prodiksion ekri",
    "Servi konekter pou relie de fraz",
    "Servi enn konstelasion pou zener lide",
    "Klas bann mo dapre lord alfabetik",
    "Lir varyete kreol ki koze dan rodrig",
    "Ekout ek konpran enn text ki lir an plizier parti",
    "Reper enn adverb parmi enn group mo, dan enn fraz ek dan enn text",
    "klasifie bann adverb",
    "servi adverb dan prodiksion ekri",
    "Reper bann omonim",
    "servi tredinion (-) dan lekritir mo",
    "Met lespas ant mo dan enn group mo ek dan enn fraz",
    "servi sinonim pou evit repetision",
    "idantifie ek koriz fot  dan enn text",
    "diferansie ant bann diferan tip fraz",
    "servi diksioner pou rod definision ek klas gramatikal bann mo",
    "konpran ek diskit lor enn sema",
    "devlop enn konpreansion kreol ki koze dan rodrig",
    "Lir ek konpran enn zistwar an plizier lepizod",
    "Diferansie ant pronom personel, posesif ek demonstratif",
    "servi pronom dan prodiksion ekri",
    "Idantifie mo-kle dan enn fraz, enn text, enn foto ek enn sema",
    "Servi \"ng\", \"sh\", ek \"ch\" dan lekritir mo",
    "Met fraz an-ord kronolozik pou fer enn zistwar",
    "Definir enn mo",
    "Fer enn 'fiksioner' ",
    "Rod bon definision enn mo dan diksioner",
    "Ekrir enn email",
    "Reper linformasion lor enn poster",
    "Lir varyete kreol ki koze dan rodrig",
    "Ekout ek konpran enn text ki an plizier parti",
    "Diferansie ant verb santiman, verb aksion ek verb ki exprimaksion mantal",
    "Servi verb ki exprim santiman, verb ki exprim aksion ek verb aksion mantal dan prodiksion ekri",
    "servi enn vokabiler presi pou exprim santiman ek lemosion",
    "servi bann expresion an kreol Repiblik moris",
    "Reper erer lozik dan enn group mo, enn fraz ou enn text",
    "servi ponktiasion avek pertinans",
    "servi enn vokabiler ris pou ekrir enn deskripsion",
    "Lir varyete kreol ki koze dan rodrig"
  ],
  "ICT skills": [
    ...
    "Working with Presentation Software",
    "Working with Presentation Software",
    "Internet: Browsing the Internet safely",
    "Internet: Browsing the Internet safely",
    "Internet: Browsing the Internet safely",
    "Internet: Browsing the Internet safely",
    "Internet: Browsing the Internet safely",
    "Internet: Browsing the Internet safely",
    "Internet: Browsing the Internet safely",
    "Multimedia: Importing Pictures from Computer",
    "Multimedia: Importing Pictures from Computer",
    "Multimedia: Importing Pictures from Computer",
    "Multimedia: Importing Pictures from Computer",
    "To avoid health risks and to use computers safely",
    "To avoid health risks and to use computers safely",
    "To avoid health risks and to use computers safely",
    "To install a learning application using playstore.",
    "To install a learning application using playstore.",
    "To install a learning application using playstore.",
    "To understand the concepts in computer operations.",
    "To understand the concepts in computer operations.",
    "To understand the concepts in computer operations.",
    "To understand the concepts in computer operations.",
    "To understand the concepts in computer operations.",
    ...
    "To understand the concepts in computer operations.",
    "To understand the concepts in computer operations.",
    "To format a document using Word 2019.",
    "To format a document using Word 2019.",
    "To format a document using Word 2019.",
    "To format a document using Word 2019.",
    "To format a document using Word 2019.",
    ...
    "To create a presentation.",
    "To create a presentation.",
    "To introduce pupils the features of a web browser.",
    "To introduce pupils the features of a web browser.",
    "To manipulate pictures.",
    "To manipulate pictures.",
    "To create an awareness of online dangers and to work safely with computers.",
    "To create an awareness of online dangers and to work safely with computers.",
    "To create an awareness of online dangers and to work safely with computers.",
    "To create an awareness of online dangers and to work safely with computers.",
  ...
  "HEALTH EDUCATION": [
    ...
    "Lesson 3-HAND WASHING",
    "Lesson 3-HAND WASHING",
    "Lesson 4-Coughing and Sneezing",
    "Lesson 4-Coughing and Sneezing",
    "Lesson 4-Coughing and Sneezing",
    " Lesson 5 __Eat a variety of foods",
    " Lesson 6 __ Meals of the Day",
    " Lesson 6 __ Meals of the Day",
    "Lesson 7 __ Food I eat for breakfast, lunch and dinner",
    " Lesson 8 __ Healthy and Less Healthy Foods",
    "Lesson 9 __ Healthy Snacks",
    "Lesson 10 __ Eating with my peers and at home",
    "Lesson 10 __ Eating with my peers and at home",
    "Lesson 10 __ Eating with my peers and at home",
    " Lesson 11 __ Keeping Safe at School (Outdoors)",
    " Lesson 12 __ Keeping Safe at School (Indoors)",
    " Lesson 13 __ Avoiding outdoor hazards",
    " Lesson 5 __ Eat a variety of foods",
    " Lesson 6 __ Eat a variety of foods",
    "Lesson 7 __ Breakfast",
    "Lesson 8 __ Lunch",
    " Lesson 9 __ Dinner",
    " Lesson 10 __ Snacks",
    "Lesson 11 __ Safety in the Kitchen",
    " Lesson 12 __ Safety in the Bedroom",
    "Lesson 13 __ Safety in the living room",
    "Lesson 14 __ Safety on stairs, windows and doors",
    "Lesson 15 __ Safety in the bathroom",
    "Lesson 5 __ Main meals and snacks",
    " Lesson 6 __ The three food groups.",
    " Lesson 6 __ The three food groups.",
    "Lesson 7 __ Importance of water ",
    "Lesson 8 __ Food for Energy",
    "Lesson 9 __ Food for Energy",
    "Lesson 10 __ Food for Growth",
    " Lesson 11 __ Food for Growth",
    "Lesson 12 __ Food for Health ",
    "Lesson 13 __ Food for Health"
  ],
  "PHYSICAL EDUCATION ": [
    "Lesson 1-Walking activities",
    "Lesson 2-Jogging and running",
    "Lesson 3- Stretching exercises (upper body)",
    "Lesson 3- stretching exercises (upper body)",
    "Lesson 4-stretching exercises (Lower body)",
    "Lesson 5-Flexibility exercises",
    "Lesson 5-Flexibility exercises",
    "Lesson 6-Breathing Exercises",
    "Lesson 7-Jumping and Landing safely",
    "Lesson 7-Jumping and Landing safely",
    "Lesson 8-Hand-eye Coordination - Balloon game",
    "Lesson 8-Hand-eye Coordination - Balloon game",
    "Lesson 9- Throwing and catching a rag ball",
    "Lesson 9- Throwing and catching a rag ball",
    "Lesson 10 - Aiming at a target",
    "Lesson 10 - Aiming at a target",
    "Lesson 1- Breathing Exercises",
    "Lesson 1- Breathing Exercises",
    "Lesson 2- Flexibility Exercises",
    "Lesson 3- Jumping and landing safely",
    "Lesson 4-Different ways of travelling",
    "Lesson 5- Combined Movements",
    "Lesson 6-Weight bearing activities for lower body parts",
    "Lesson 6-Weight bearing activities for lower body parts",
    "Lesson 6-Weight bearing activities for lower body parts",
    "Lesson 7-Balancing a ball on a Racket",
    "Lesson 7-Balancing a ball on a Racket",
    "Lesson 8-Balancing objects with different parts of the body",
    "Lesson 8-Balancing objects with different parts of the body",
    "Lesson 8-Balancing objects with different parts of the body",
    "Lesson 9-Taking weight on different parts of the body",
    "Lesson 9-Taking weight on different parts of the body",
    "Lesson 10-Throwing and catching",
    "Lesson 10-Throwing and catching",
    "LESSON 1 - Balance Exercises",
    "LESSON 1 - Balance Exercises",
    "LESSON 2 - Balance",
    "LESSON 2 - Balance",
    "LESSON 3 - Endurance Race",
    "LESSON 4 - Sprint: Shuttle Relay",
    "LESSON 5 - Squat Jumps",
    "LESSON 6 - Throws",
    "LESSON 1 - Mini Football",
    "LESSON 2 - Mini Football",
    "LESSON 3 - Mini Football",
    "LESSON 4 - Mini Football",
    "LESSON 5 - Handball",
    "LESSON 6 - Mini Handball (Part I)",
    "LESSON 6 - Mini Handball (Part II",
    "LESSON 6 - Mini Handball (Part II",
    "LESSON 7 - Racket Games",
    "LESSON 7 - Racket Games",
    "LESSON 1.1: Sprint - Shuttle Relay",
    "LESSON 1.2: Sprint - Obstacle Race",
    "LESSON 1.3: Jumping - High Jump",
    "LESSON 1.4: Endurance Race",
    "LESSON 2.1: Stretching Exercises",
    "LESSON 2.2: Heart rate/Pulse rate",
    "LESSON 2.3: Strengthening Exercises",
    "LESSON 2.4: Aerobic / Endurance Exercises",
    "LESSON 3.1: Handball - Dribbling",
    "LESSON 3.2: Handball - Defence",
    "LESSON 3.2: Handball - Defence",
    "LESSON 3.3: Handball - League Tournament",
    "LESSON 3.4: Football - Dribbling",
    "LESSON 3.5: Football - Defence",
    "LESSON 3.5: Football - Defence",
    "LESSON 3.6: Football - League Tournament",
    "LESSON 4.1: Standing Yoga Poses",
    "LESSON 4.2: Sitting/Lying Yoga Poses",
    "LESSON 4.3: Circuit Training"
  ],
  "PHYSICAL EDUCATION": [
    "Lesson 1 __ Hands and arms coordination",
    "Lesson 1 __ Hands and arms coordination",
    " Lesson 2 __Legs coordination",
    " Lesson 2 __Legs coordination",
    "Lesson 3 __ Arms and legs coordination",
    "Lesson 3 __ Arms and legs coordination",
    "Lesson 4 __ Arms and legs coordination",
    "Lesson 4 __ Arms and legs coordination",
    "Lesson 5 __ Static balance",
    "Lesson 5 __ Static balance",
    "Lesson 6 __ Dynamic balance",
    "Lesson 6 __ Dynamic balance",
    "Lesson 6 __ Dynamic balance",
    " Lesson 7 __ Balance objects on different body parts",
    "Lesson 8 __ Controlled movement",
    "Lesson 8 __ Controlled movement",
    " Lesson 9 __ Strength activities",
    " Lesson 9 __ Strength activities",
    "Lesson 10 __ Strength activities",
    "Lesson 1 __ Hopping",
    "Lesson 1 __ Hopping",
    " Lesson 2 __ Skipping",
    " Lesson 2 __ Skipping",
    "Lesson 3 __   Consolidation of jogging, running,  jumping and landing",
    " Lesson 4 __ Relays",
    " Lesson 4 __ Relays",
    " Lesson 5 __ Agility",
    " Lesson 6 __ Manipulative Games",
    " Lesson 6 __ Manipulative Games",
    " Lesson 7 __ Moving around",
    " Lesson 7 __ Moving around",
    " Lesson 8 __ Moving around - in specific directions",
    " Lesson 8 __ Moving around - in specific directions",
    "Lesson 9 __ Outdoor games",
    " Lesson 10 __ Orienteering",
    " Lesson 10 __ Orienteering",
    "Lesson 1 __ Different ways of moving",
    "Lesson 1 __ Different ways of moving",
    " Lesson 2 __ Movement in various directions",
    " Lesson 2 __ Movement in various directions",
    " Lesson 3 __  Movement in various directions",
    " Lesson 3 __  Movement in various directions",
    "Lesson 4 __  Passing and moving forward (Hand)",
    "Lesson 4 __  Passing and moving forward (Hand)",
    "Lesson 5 __ Kicking and dribbling",
    "Lesson 5 __ Kicking and dribbling",
    "Lesson 6 __ Kicking at a target",
    "Lesson 6 __ Kicking at a target",
    "Lesson 7 __ Taking weight on different body parts (Belly)",
    "Lesson 7 __ Taking weight on different body parts (Belly)",
    "Lesson 8 __   Taking weight on different body parts (Bottom/Back)",
    "Lesson 8 __   Taking weight on different body parts (Bottom/Back)",
    " Lesson 9 __ Throwing and catching activities",
    " Lesson 9 __ Throwing and catching activities",
    "Lesson 10 __ Rolling and bouncing",
    "Lesson 10 __ Rolling and bouncing",
    " Lesson 1 __ Weight bearing activities (feet, arms, shoulders)",
    "Lesson 2 __ Weight bearing activities (feet, arms, shoulders)",
    "Lesson 2 __ Weight bearing activities (feet, arms, shoulders)",
    "Lesson 3 __ Locomotor and strength activities",
    "Lesson 3 __ Locomotor and strength activities",
    " Lesson 4 __ Locomotor and strength activities",
    "Lesson 5 __ Throwing at a target",
    "Lesson 5 __ Throwing at a target",
    "Lesson 6 __ Kicking and dribbling",
    "Lesson 7 __ Map reading - desktop map",
    "Lesson 7 __ Map reading - desktop map",
    "Lesson 8 __ Map reading - map of desk",
    "Lesson 8 __ Map reading - map of desk",
    "Lesson 9 __ Using maps to orientate (to move around)",
    "Lesson 9 __ Using maps to orientate (to move around)",
    " Lesson 10 __ Control markers",
    "Lesson 1 __ Balancing in pairs ",
    "Lesson 2 __ Taking weights on different parts of the body (sitting position) ",
    "Lesson 3 __ Exploring movement concepts ",
    "Lesson 3 __ Exploring movement concepts ",
    "Lesson 4 __ Combining locomotor skills ",
    " Lesson 5 __ Passing and receiving with hands",
    " Lesson 5 __ Passing and receiving with hands ",
    "Lesson 6 __ Kicking and stopping various objects ",
    "Lesson 6 __ Kicking and stopping various objects ",
    "Lesson 7 __ Passing and receiving (hands) ",
    "Lesson 7 __ Passing and receiving (hands) ",
    " Lesson 8 __ Passing and receiving (feet)",
    " Lesson 8 __ Passing and receiving (feet) ",
    "Lesson 9 __ Dribbling with feet ",
    "Lesson 9 __ Dribbling with feet ",
    "Lesson 10 __ Dribbling and passing (feet) ",
    "Lesson 10 __ Dribbling and passing (feet) ",
    "Lesson 1 __ Aiming at a target – Hand ",
    "Lesson 1 __ Aiming at a target – Hand ",
    "Lesson 2 __ Aiming at a target – Feet ",
    "Lesson 2 __ Aiming at a target – Feet ",
    " Lesson 3 __ Controlled pass and movement – Hand ",
    "Lesson 4 __ Controlled pass and movement – Hand ",
    "Lesson 5 __ Intercepting/catching passes – Hand ",
    " Lesson 6 __ Intercepting passes – Feet ",
    " Lesson 7 __ Orienteering within the class ",
    "Lesson 8 __ Orienteering using the map ",
    "Lesson 9 __ Orienteering within the playground ",
    "Lesson 10 __ Orienteering and map reading "
  ],
  "Visual Arts": [
    "Lesson 1-1-1: Let’s make dots and scribbles",
    "Lesson 1-1-1: Let’s make dots and scribbles",
    "Lesson 1-1-1: Let’s make dots and scribbles",
    "Lesson 1-1-1: Let’s make dots and scribbles",
    "Lesson 1-1-2: Types of Lines and Dots",
    "Lesson 1-1-2: Types of Lines and Dots",
    "Lesson 1-1-3: My Decorated Hand",
    "Lesson 1-2-1: Creating art with regular shapes",
    "Lesson 1-2-1: Creating art with regular shapes",
    "Lesson 1-2-2: Creating art with irregular shapes",
    "Lesson 1-2-3: Creating art with regular and irregular shapes",
    "Lesson 1-2-3: Creating art with regular and irregular shapes",
    "Lesson 1-3-1: Creating art with magical colours",
    "Lesson 1-3-2: Creating art with primary colours",
    "Lesson 1-3-2: Creating art with primary colours",
    "Lesson 1-3-3: Creating art with primary colours through blobbing and splattering",
    "Lesson 2-x-1: Decorating a hand with lines, dots, shapes and colours",
    "Lesson 2-x-2: Creating an artwork with lines, dots, shapes and colours",
    "Lesson 2-4-1: Taking prints with fingers and the hand",
    "Lesson 2-4-1: Taking prints with fingers and the hand",
    "Lesson 2-4-1: Taking prints with fingers and the hand",
    "Lesson 2-4-2: Creating a picture using hand and finger prints",
    "Lesson 2-5-1: Creating a ‘ribambelle’ using collage",
    "Lesson 2-5-2: Greeting Card Collage",
    "Lesson 2-6-1: Assemblage of an octopus",
    "Lesson 2-6-2: Assemblage of a dodo",
    "Lesson 2-6-3: Assemblage of a butterfly",
    "Lesson 2-x-2-Further Art Activities on Printmaking, Collage and Assemblage",
    "Lesson 2-7-1: Modelling techniques",
    "Lesson 2-7-1: Modelling techniques",
    "Lesson 2-7-1: Modelling techniques",
    "Lesson 2-7-2: Making objects using pinching and coiling",
    "Lesson 2-8-1: Exploring created textures through rubbing",
    "Lesson 2-8-1: Exploring created textures through rubbing",
    "Lesson 2-8-2: Exploring natural textures through rubbing",
    "Lesson 2-8-3: Creating a landscape with textures",
    "Lesson 2-9-1: Folding a paper dog",
    "Lesson 2-9-2: Folding a paper cat",
    "Lesson 1-1-1: Thematic Composition",
    "Lesson 1-1-2 &1-1-3: Let’s create a composition on ‘People at work ’",
    "Lesson 1-2-1: My colourful mandala",
    "Lesson 1-2-2: Flora and fauna mandala",
    "Lesson 1-2-3: Flora and fauna mandala",
    "Lesson 1-3-1: Preparing an abstract portrait",
    "Lesson 2-x-1 – I draw fairy characters",
    "Lesson 2-x-2: I create a wonderland.",
    "Lesson 2-4-1: Decorating shapes with paper pellets",
    "Lesson 2-4-1: Decorating shapes with paper pellets",
    "Lesson 2-4-2: Decorating a landscape with paper pellets",
    "Lesson 2-4-2: Decorating a landscape with paper pellets",
    "Lesson 2-4-1: Designing the totem pole",
    "Lesson 2-4-2: Finishing the totem pole",
    "Lesson 2-4-1: Creating textured shapes with modelling clay",
    "Lesson 2-4-1: Creating textured shapes with modelling clay",
    "Lesson 2-4-2 - My animal in relief sculpture",
    "Lesson 2-x-1: Relief sculpture",
    "Lesson 2-x-2: Totem pole and paper pellets",
    "Lesson 2-x-2: Totem pole and paper pellets",
    "Lesson 2-7-1 – Draw and colour animals",
    "Lesson 2-7-2 – Creating a paper plate mask",
    "Lesson 2-8-1 – Vegetable Printing",
    "Lesson 2-8-1 – Vegetable Printing",
    "Lesson 2-8-2: Vegetable printing landscape",
    "Lesson 2-8-2: Vegetable printing landscape",
    "Lesson 2-9-1: Folding a paper fish",
    "Lesson 2-9-1: Folding a paper fish",
    "Lesson 2-9-1: Folding a paper fish"
  ],
  "Performing Arts": [
    "Lesson 1: Beat and Pitch (Music)",
    " Lesson 2: Pitch (Music)",
    " Lesson 3: Miming and Breathing (Drama)",
    " Lesson 4: I move my body to dance(Dance)",
    "Lesson 5: On the Dance Floor (Dance)",
    "Lesson 6: Movement with Emotions (Drama)",
    " Lesson 7: Actions and Reactions (Drama)",
    " Lesson 8: Follow the leader (Dance)",
    " Lesson 9: Creative Hands (Dance)",
    "Lesson 10: Steady Beats with Percussion Instruments (Music)",
    " Lesson 11: Let’s make a shaker (Music) ",
    "Lesson 12: Roll-Dice-Action (Drama) ",
    "Lesson 13: Project Work",
    ...
    "Lesson18: Families of Musical Instruments (Music)",
    "Lesson 1: Enacting people at work (Drama)",
    " Lesson 2: Imitating forest animals (Drama)",
    " Lesson 3: Creating different story endings (Drama)",
    " Lesson 4: Move to music (Dance)",
    " Lesson 5: I feel and express (Dance)",
    "Lesson 6: Recognising basic rhythmic notation representing one beat and two-beat musical notes (Music)",
    " Lesson 7: Sing  the seven musical notes (Music)",
    "Lesson 8: Singing a song on seven notes (in English, French and/or Hindi) (Music)",
    "Lesson 9: Music elements, sounds, moods and effects (Music)",
    "Lesson 10: I see dance everywhere (Dance)",
    "Lesson 11: We dance as one (Dance)"
  ],
  "Road Safety Education": [
    "Lesson 1-Importance of the road",
    "Lesson 2-Types of roads",
    "Lesson 3-Reasons for using the road",
    "Lesson 4-Types of road furniture (Part 1)",
    "Lesson 5-Types of road furniture (Part 2)",
    "Lesson 6-Signal lights",
    "Lesson 7-Pelican crossing",
    "Lesson 8-Importance of traffic signs",
    "Lesson 9-Types of road furniture – bridges",
    "Lesson 10-Types of road users (Part 1)",
    "Lesson 11-Types of road users (Part 2)",
    "Lesson 12-Types of vehicles (Part 1)",
    "Lesson 13-Types of vehicles (Part 2)",
    "Lesson 14-Safe and unsafe places on the road",
    "Lesson 15-Proper dress code",
    "Lesson 16-Walking to school",
    "Lesson 17-Walking to school",
    "Lesson 18-Safe practices when walking with an adult",
    "Lesson 19-Personal safety – Do’s and Don’ts",
    "Lesson 19-Personal safety – Do’s and Don’ts",
    "Lesson 20-Safety on the road – Do’s and Don’ts",
    "Lesson 21-Consequences of unsafe road behaviours (Part 1)",
    "Lesson 22-Consequences of unsafe road behaviours (Part 2)",
    "Lesson 23-Good behaviours when travelling by school van",
    "Lesson 24-Good behaviours when using travelling by bus",
    "Lesson 25-Good behaviours when travelling by car",
    "Lesson 26-Good behaviours when travelling by car",
    "Lesson 27-Importance of seat belts",
    "Lesson 27-Importance of seat belts",
    "Lesson 28-Good behaviours on a two-wheeler",
    "Lesson 1-Be aware of the surroundings",
    "Lesson 2-I walk around the school compound",
    "Lesson 3-Spot the safe places in the school compound",
    "Lesson 4-Safe places to walk in school compound",
    "Lesson 5-Using the pedestrian gate to get in and out of the school compound",
    "Lesson 6-Footpath",
    "Lesson 7- Safe use of footpaths ",
    "Lesson 9-Driveways",
    "Lesson 10-I spot hazardous situations on the road",
    "Lesson 11-Pick up and Drop off points",
    "Lesson 12-Safety precautions in danger zones near vehicle",
    "Lesson 13-Good behaviours when waiting at a ‘Pick up’ and ‘Drop off’ point",
    "Lesson 14-How to behave in the car park",
    "Lesson 15-Walking on the right-hand side of the road facing oncoming vehicles",
    " Lesson 16-Safe behaviour on the road",
    "Lesson 17-Walking in a single file on the footpath to avoid accidents",
    "Lesson 18-Good behaviours on the road",
    "Lesson 19-Responsible behaviours on the road",
    "Lesson 20- Safe or unsafe behaviours on the road",
    "1-Always be attentive on the road",
    "2-Types of roads (motorways and main roads)",
    "3-Types of roads (narrow and wide roads)",
    "4-Vehicles’ directions on the road",
    "5-One-way road and Two-way road",
    "6-Road markings",
    "7-Types of footpaths",
    "8-Types of footpaths",
    "9-Importance of seeing all oncoming vehicles",
    "10-Importance of being seen on the road",
    "11-Crossing the road safely",
    "12-Zebra Crossing",
    "13-Steps to cross the road at a Zebra Crossing",
    "14-Traffic signal lights for pedestrians (Pelican Crossing)",
    "15-Pelican Crossing",
    "16-Types of crossing (Pelican Crossing)",
    "17-Crossing zone",
    "18-Good and bad practices when crossing the road",
    "19-Close and Far, Towards and Away, Fast and Slow",
    "20-Types of crossing (Footbridge, Underpass and pedestrian ",
    "21-The road and weather conditions (Part 1)",
    "22-The road and weather conditions (Part 2)",
    "23-Appropriate clothing during bad weather conditions when on the road",
    "24-Be Bright Be Seen",
    "25-Intersections",
    "26-Road accidents in relation to pedestrians’ behaviours",
    "Lessons 1&2-Traffic Signs in relation to crossing the road",
    "Lessons 3&4-Road Humps",
    "Lessons 5&6-Types of Pedestrian crossing: Humped Pedestrian Crossing",
    "lesson 7-Identification of Signal Lights (vehicles)",
    "lessons  8&9-Identification of Signal Lights (Pedestrians)",
    "lesson 10-Types of Pedestrians Crossing: Pelican Crossing",
    "lesson 11-Steps for using the Pelican Crossing.",
    "lesson 12& 13-Crossing the road at a signalised junction with pedestrian phase",
    "lesson 14 & 15-Types of Pedestrian crossing: Footbridge",
    "lesson 16-Types of Pedestrian Crossing: Underpass.(also known as Subway)",
    "lesson 17 & 18-Hazards on the road (Me as a pedestrian)",
    "lesson 19-Hazards on the road",
    "lesson 20 -21-Crossing the road",
    "lesson 22 -23- Dangerous places to cross the road (Part 1)",
    "lesson 24-Dangerous places to cross the road ",
    "lesson 25-Crossing the road where there is no pedestrian crossing facilities",
    "lesson 26-27-Police Officer regulating traffic at a Pedestrian crossing",
    "lesson 1- The Bicycle",
    "lesson 2-The different parts of the bicycle and their functions",
    "lesson 3-Safety accessories for the bicycle",
    "lesson 4-Safety features of the bicycle",
    "lesson 5A-Safety gears and their importance - Helmet",
    "lesson 5B-The importance of safety gears.",
    "lesson 6-Hazards involved when riding a bicycle",
    "lesson 7-Risky behaviours when riding a bicycle",
    "lesson 8-9-Getting to know if a bicycle fits me",
    "lesson 10 -11-Riding the bicycle",
    "lesson 12-13-Traffic signs and signals",
    "lesson 14-Hand signals",
    "lesson 15-16-Control a bicycle using your hands",
    "lesson 17-18-Braking Techniques",
    "lesson 19- 20-Getting on and off a bicycle",
    "lesson 21-22 -Balance the bicycle",
    "lesson 23-24-Start riding a bicycle",
    "Lesson 25 & 26-Ride in a straight line",
    "Lesson 27 & 28-Ride in between Cones",
    "Lesson 29 & 30-Negotiate a bend safely",
    "lesson 1 & 2-Rules and regulations for riding bicycles",
    "lesson 3-Advantages of using a bicycle",
    "lesson 4-Riding the bicycle at night",
    "lesson 5-Directional cues from motorists",
    "lessons 6&7-Using the roundabout",
    "lesson 8-Weather conditions and bicycle",
    "Lessons 9 & 10- Importance of the Light Rail Vehicle",
    "Lesson  11-The Light Rail Vehicle",
    "Lesson 12 & 13 - The Platform",
    "Lessons 14 & 15- Regulations and Light Rail",
    "Lessons 16 & 17 |Traffic Signs (Light Rail Vehicle)",
    "Lesson 18-Travelling by the Light Rail Vehicle",
    " Lesson 19 -Safety Issues When Using the Light Rail Vehicle",
    "Lessons 20 & 21-Speed Deterrents",
    "Lesson  22-Traffic signs related to speed limit",
    "Lesson 23 & 24- Road Markings",
    "Lesson 25-Right and left turn",
    "Lesson 26 & 27- Ride a Bicycle at T-junctions",
    "Lesson 28 & 29-Changing lanes",
    "Lesson 30-Stopping at signal lights",
    "Lesson 31-Riding at roundabouts",
    "Lesson 32-Cooperative cycling"
  ],
  "Values and citizenship education ": [
    ...
    "Lesson 5 –  My family",
    "Lesson 6 – My friends",
    "Lesson 7 – Friendship Day",
    "Lesson 8 – Working together ",
    "Lesson 8 – Working together ",
    "Lesson 9 –  I am a good listener",
    "Lesson 9 –  I am a good listener",
    "Lesson 10 – Good manners",
    "Krea Special ",
    "Lesson 11 –  My country",
    "Lesson 11 –  My country",
    "Lesson 12 – Unity ",
    "Lesson 12 – Unity ",
    "Lesson 13 – Caring for the environment",
    " Krea Special 1 ",
    "Lesson 1 – Unity ",
    "Lesson 2 – All about me",
    " Lesson 3 – Grooming and personal care",
    "Lesson 4 – My hair care practices",
    "Lesson 5- The puzzles",
    "Lesson 6 – My Home ",
    "Lesson 7 – I keep my room clean",
    "Lesson 8 – I learn how to fold my clothes",
    "Krea Special ",
    "Lesson 9 – My family",
    "Lesson 10 – Magical words",
    "Lesson 11 – I greet everyone",
    "Lesson 12 – I take care of my pets ",
    "Lesson 13 - I collaborate with my friends",
    "Krea Special ",
    "Lesson 14 – National Anthem",
    "Lesson 15 – Islands of the Republic of Mauritius",
    "Lesson 16 – The national bird of the Republic of Mauritius",
    "Lesson 17 – The national flower of the Republic of Mauritius ",
    "Lesson 18 - Taking care of the environment ",
    "Krea Special  ",
    ...
    " LESSON 4: All about me",
    "LESSON 5: A good Pupil ",
    "LESSON 6: Go for good manners",
    "LESSON 6: Go for good manners",
    "LESSON 7: My Family ",
    "LESSON 7: My Family ",
    "LESSON 8: Respecting the elders ",
    "LESSON 8: Respecting the elders ",
    "LESSON 9: Friendship",
    "LESSON 9: Friendship",
    "Krea special",
    "LESSON 11: Independence Day",
    "LESSON 12: Past and Present ",
    "LESSON 13: Respecting the environment",
    "LESSON 13: Respecting the environment",
    "Krea special",
    "Towards the best of me",
    "Towards the best of me",
    "Towards the best of me",
    ...
    "Lesson 14 – Reaffirming my values",
    "Lesson 14 – Reaffirming my values",
    "Lesson 1 – Experiencing values",
    "Lesson 1 – Experiencing values",
    "Lesson 1 – Experiencing values",
    "Lesson 2 – Identifying my problems ",
    "Lesson 2 – Identifying my problems ",
    "Lesson 3 – My timeline",
    "Lesson 3 – My timeline",
    "Lesson 3 – My timeline",
    "Lesson 4 – Being emotionally smart",
    "Lesson 4 – Being emotionally smart",
    "Lesson 4 – Being emotionally smart",
    "Lesson 4 – Being emotionally smart",
    ...
    "Lesson 5 – My rights and responsibilities",
    "Lesson 5 – My rights and responsibilities",
    "Lesson 6 – Being respectful",
    "Lesson 6 – Being respectful",
    "Lesson 6 – Being respectful",
    "Lesson 6 – Being respectful",
    "Lesson 7 – What about others?",
    "Lesson 7 – What about others?",
    "Lesson 7 – What about others?",
    "Lesson 8 – Respecting pets ",
    "Lesson 8 – Respecting pets ",
    ...
    "Lesson 10 – Decision Making",
    "Lesson 10 – Decision Making",
    "Lesson 11 – Coping with emotions",
    "Lesson 11 – Coping with emotions",
    "Lesson 11 – Coping with emotions",
    "Lesson 11 – Coping with emotions",
    "Lesson 12 – Celebrating unity in diversity ",
    "Lesson 12 – Celebrating unity in diversity ",
    "Lesson 12 – Celebrating unity in diversity ",
    ...
    "Lesson 14 – My vision ",
    "Lesson 14 – My vision ",
    "Lesson 15 –  My identity",
    "Lesson 15 –  My identity",
    "Lesson 15 –  My identity",
    "Lesson 15 –  My identity",
    "Lesson 16 –  Saving Lives ",
    "Lesson 16 –  Saving Lives ",
    "Lesson 16 –  Saving Lives "
  ],
  "Subject": [
  ...
  "ICT": [
    ...
    "Browsing the Internet safely",
    "Browsing the Internet safely",
    "Multimedia:Working with shapes",
    "Multimedia:Working with shapes",
    "Multimedia:Working with shapes",
    "Multimedia:Working with shapes",
    "Multimedia:Working with shapes",
  ...
  "Health Education": [
    "Lesson 1-Good grooming",
    "Lesson 1-Good grooming",
    "Lesson 1-Good grooming",
    "Lesson 1-Good grooming",
    "Lesson 1-Good grooming",
    "Lesson 1-Good grooming",
    "Lesson 2-Dental Care",
    "Lesson 2-Dental Care",
    "Lesson 2-Dental Care",
    "Lesson 2-Dental Care",
    "Lesson 2-Dental Care",
    "Lesson 3-Hand washing: caring for my hands and nails",
    "Lesson 3-Hand washing: caring for my hands and nails",
    "Lesson 3-Hand washing: caring for my hands and nails",
    "Lesson 3-Hand washing: caring for my hands and nails",
    "Lesson 4-Importance of eating",
    "Lesson 4- Sources of food",
    "Lesson 4- Sources of food",
    "Lesson 4- Sources of food"
  ],
  "Physical Education": [
    "Lesson 1-Different ways of moving",
    "Lesson 1-Different ways of moving",
    "Lesson 2- Different Ways of Moving",
    "Lesson 3- Weight bearing activities for upper parts of the body (arms and shoulders)",
    "Lesson 4-Weight bearing activities for upper parts of the body (arms and shoulders)",
    "Lesson 5- Bending, Twisting and Stretching Movements",
    "Lesson 6- Bending, Twisting and Stretching Movements",
    "Lesson 6- Bending, Twisting and Stretching Movements",
    "Lesson 7- Jumping and Leaping Activities",
    "Lesson 7- Jumping and Leaping Activities",
    "Lesson 8- Throwing and Catching activities",
    "Lesson 8- Throwing and Catching activities",
    "Lesson 9- Rolling and Bouncing",
    "Lesson 9- Rolling and Bouncing",
    "Lesson 10-Throwing at a target",
    "Lesson 10-Throwing at a target"
  ],
  "Visual Arts ": [
    "Lesson 1-1-1: I create new types of lines",
    "Lesson 1-1-1: I create new types of lines",
    "Lesson 1-1-1: I create new types of lines",
    "Lesson 1-1-1: I create new types of lines",
    "Lesson 1-1-2: I draw my locality",
    "Lesson 1-2-1: Mixing Primary Colours",
    "Lesson 1-2-2: I use secondary colours to paint a seascape",
    "Lesson 1-2-2: I use secondary colours to paint a seascape",
    "Lesson 1-2-3: I use secondary colours to paint a floral design",
    "Lesson 1-3-1: Leaf printing",
    "Lesson 1-3-2: Leaf printing on a coloured background",
    "Lesson 1-3-3: I create a postcard with leaf prints",
    "Lesson 2-x-1: Using lines, dots and colours to create art",
    "Lesson 2-x-1: Using lines, dots and colours to create art",
    "Lesson 2-4-1: Cut out paper collage",
    "Lesson 2-4-2: Torn paper collage",
    "Lesson 2-4-3: Creating a collage on nature",
    "Lesson 2-5-1: Painting the parts of a mobile",
    "Lesson 2-5-2: Decorating the parts of a mobile",
    "Lesson 2-5-3: Mounting the parts of a mobile",
    "Lesson 2-5-4: Assembling the different parts into a mobile",
    "Lesson 2-x-1: Lines, Colours and Collage",
    "Lesson 2-x-1: Lines, Colours and Collage",
    "Lesson 2-x-2: Printmaking, Collage and Mobile",
    "Lesson 2-6-1: Slabbing, Coiling and Pinching",
    "Lesson 2-6-2: Relief Animals",
    "Lesson 2-6-2: Relief Animals",
    "Lesson 2-6-2: Relief Animals",
    "Lesson 2-6-3: Animals in the round",
    "Lesson 2-6-1: My Sgraffito",
    "Lesson 2-6-2: My Sgraffito on Nature",
    "Lesson 2-7-1: Paper Bag Butterfly",
    "Lesson 2-7-2: Paper Bag Frog"
  ],
  "HEALTH EDUCATION ": [
    "Lesson 1- Importance of daily shower",
    "Lesson 1- Importance of daily shower",
    "Lesson 1- Importance of daily shower",
    "Lesson 1- Importance of daily shower",
    "Lesson 2- Hand Washing",
    "Lesson 2- Hand Washing",
    "Lesson 2- Hand Washing",
    "Lesson 2- Hand Washing",
    "Lesson 3- Dental Care",
    "Lesson 3- Dental Care",
    "Lesson 3- Dental Care",
    "Lesson 3- Dental Care",
    "LESSON 1 – Food and Food Safety",
    "LESSON 1 – Food and Food Safety",
    "LESSON 1 – Food and Food Safety",
    "LESSON 2 – Safe and Unsafe Food",
    "LESSON 2 – Safe and Unsafe Food",
    "LESSON 2 – Safe and Unsafe Food",
    "LESSON 3 – Safe and Unsafe Food Handling Practices",
    "LESSON 3 – Safe and Unsafe Food Handling Practices",
    "LESSON 3 – Safe and Unsafe Food Handling Practices",
    ...
    "LESSON 4 – Food Labels",
    "LESSON 4 – Food Labels",
    "LESSON 1 – Tobacco Smoking",
    "LESSON 1 – Tobacco Smoking",
    "LESSON 1 – Tobacco Smoking",
    "LESSON 1 – Tobacco Smoking",
    "LESSON 1 – Tobacco Smoking",
    "LESSON 2 – Consuming Alcohol",
    "LESSON 2 – Consuming Alcohol",
    "LESSON 2 – Consuming Alcohol",
    "LESSON 2 – Consuming Alcohol",
    "LESSON 3 – Harmful Effects of Inhalants",
    "LESSON 3 – Harmful Effects of Inhalants",
    "LESSON 3 – Harmful Effects of Inhalants",
    "LESSON 1 – Puberty",
    "LESSON 1 – Puberty",
    "LESSON 1 – Puberty",
    "LESSON 2 – More Changes Related to Puberty",
    "LESSON 2 – More Changes Related to Puberty",
    "LESSON 2 – More Changes Related to Puberty",
    "LESSON 2 – More Changes Related to Puberty",
    "LESSON 2 – More Changes Related to Puberty",
    "LESSON 3 – Private Body Parts",
    "LESSON 3 – Private Body Parts",
    "LESSON 3 – Private Body Parts",
    "LESSON 4 – Safe Touches and Unsafe Touches",
    "LESSON 4 – Safe Touches and Unsafe Touches",
    "LESSON 4 – Safe Touches and Unsafe Touches",
    "LESSON 4 – Safe Touches and Unsafe Touches",
    "LESSON 1 - Who are safe adults?",
    "LESSON 1 - Who are safe adults?",
    "LESSON 2 - Special Safe and Trusted Adults",
    "LESSON 2 - Special Safe and Trusted Adults",
    "LESSON 3 - Staying Away from Strangers",
    "LESSON 3 - Staying Away from Strangers",
    "LESSON 3 - Staying Away from Strangers",
    "LESSON 3 - Staying Away from Strangers",
    "LESSON 4 - Online Safety Precautions",
    "LESSON 4 - Online Safety Precautions",
    "LESSON 4 - Online Safety Precautions",
    "LESSON 4 - Online Safety Precautions",
    "LESSON 4 - Online Safety Precautions",
    "LESSON 4 - Online Safety Precautions",
    "LESSON 1.1: Communicable Diseases",
    "LESSON 1.1: Communicable Diseases",
    "LESSON 1.1: Communicable Diseases",
    "LESSON 1.2: HIV and AIDS",
    "LESSON 1.2: HIV and AIDS",
    "LESSON 1.2: HIV and AIDS",
    "LESSON 1.3: Consequences of Unhealthy Eating",
    "LESSON 1.3: Consequences of Unhealthy Eating",
    "LESSON 1.3: Consequences of Unhealthy Eating",
    "LESSON 1.3: Consequences of Unhealthy Eating",
    "LESSON 1.4: Preventing Obesity and Diabetes",
    "LESSON 1.4: Preventing Obesity and Diabetes",
    "LESSON 2.1: Effects of Alcohol and Tobacco Smoking",
    "LESSON 2.1: Effects of Alcohol and Tobacco Smoking",
    "LESSON 2.1: Effects of Alcohol and Tobacco Smoking",
    "LESSON 2.2: Saying ‘NO’ to Alcohol and Smoking",
    "LESSON 2.2: Saying ‘NO’ to Alcohol and Smoking",
    "LESSON 2.3: ‘No Smoking and No Drinking’ School Sensitisation",
    "LESSON 3.1: Changes Associated with Puberty",
    "LESSON 3.1: Changes Associated with Puberty",
    "LESSON 3.2: Coping with changes during puberty",
    "LESSON 4.1: Digital Communication Devices",
    "LESSON 4.1: Digital Communication Devices",
    "LESSON 4.2: Online Safety and Electronic Games",
    "LESSON 4.2: Online Safety and Electronic Games",
    "LESSON 4.3: Safe practices in sports",
    "LESSON 4.3: Safe practices in sports",
    "LESSON 4.4: R.I.C.E.R Treatment",
    "LESSON 4.4: R.I.C.E.R Treatment"
  ],
  "Health ": [
    "Lesson 1 - Causes of illness",
    "Lesson 1 - Causes of illness",
    "Lesson 2: How do germs spread?",
    "Lesson 2: How do germs spread?",
    "Lesson 2: How do germs spread?",
    "Lesson 2: How do germs spread?",
    "Lesson 3: Protect myself against germs.",
    "Lesson 3: Protect myself against germs.",
    "Lesson 3: Protect myself against germs.",
    "Lesson 1 - Balanced meals",
    "Lesson 1 - Balanced meals",
    "Lesson 1 - Balanced meals",
    "Lesson 2 - Breakfast",
    "Lesson 2 - Breakfast",
    ...
    "Lesson 4 - Dinner",
    "Lesson 4 - Dinner",
    "Lesson 5 - Healthy and Unhealthy Eating",
    "Lesson 5 - Healthy and Unhealthy Eating",
    "Lesson 5 - Healthy and Unhealthy Eating",
    "Lesson 1 - Harmful substances in the environment",
    "Lesson 1 - Harmful substances in the environment",
    "Lesson 2 - Safety issues when Using Harmful Substances",
    "Lesson 2 - Safety issues when Using Harmful Substances",
    "Lesson 3 - Other common Harmful Substances in the environment",
    "Lesson 3 - Other common Harmful Substances in the environment",
    "Lesson 3 - Other common Harmful Substances in the environment",
    "Lesson 4: Harmful Substances: Tobacco, Alcohol and Organic Solvents",
    "Lesson 4: Harmful Substances: Tobacco, Alcohol and Organic Solvents",
    "Lesson 4: Harmful Substances: Tobacco, Alcohol and Organic Solvents",
    "Lesson 4: Harmful Substances: Tobacco, Alcohol and Organic Solvents",
    "Lesson 4: Harmful Substances: Tobacco, Alcohol and Organic Solvents",
    "Lesson 1 - Safety in the school yard & playground",
    "Lesson 1 - Safety in the school yard & playground",
    "Lesson 1 - Safety in the school yard & playground",
    "Lesson 2 - Classroom safety",
    "Lesson 2 - Classroom safety",
    "Lesson 2 - Classroom safety",
    "Lesson 2 - Classroom safety",
  ...
  "Physical education ": [
    "Lesson 1 - Controlled Balance",
    "Lesson 2 - Balancing",
    "Lesson 3 - jumps",
    "Lesson 4 - Balancing with ball",
    "Lesson 1 - Endurance Race",
    "Lesson 2 - Jumps",
    "Lesson 3 - Fast running",
    "Lesson 4 - Throws",
    "Lesson 1 - Mini Football",
    "Lesson 2 - Mini Football",
    "Lesson 3 - Defensive Skills",
    "Lesson 4 - Playing Mini Football",
    "Lesson 1 - Mini Handball",
    "Lesson 2 - Mini Handball",
    "Lesson 3 - Mini Handball",
    "Lesson 4 - Mini Handball",
    "Lesson 1 - Racket Games",
    "Lesson 2 - Racket Games"
  ],
  "Visual arts": [
    "Drawing with numeral 1",
    "Drawing with numeral 2",
    "Drawing with numeral 3",
    "Drawing with numeral 4",
    "Make a whale",
    "Make a cat",
    "Make a paper composition with paper folding and drawing numerals elements. ",
    "Learn to use synthetic clay ",
    "Some techniques using synthetic clay",
    "Sculpt with synthetic clay",
    "Decorate your paper plate using techniques you have learned earlier (painting and printing)",
    "Complete the pattern  using the same colours provided.",
    "creating a tessellation",
    "Use corrugated carton and potato blocks to create a composition",
    "Vary the prints so as to create a picture composition.",
    "Use some fabrics and scrap materials.",
    "Cut out the  the materials required foryour mobile in different forms .\r\n",
    "Reflect on the different aspects of recycling",
    "Use the template on page 117 to create a paper garland",
    "Use Bristol paper or card to trace and cut out a template ,Place the template on the strip",
    "Colour and decorate it as you wish.",
    "Create a folder where you will keep your work",
    "Gives a realistic appearance to your drawing.",
    "The steps to apply shade",
    "Apply shade",
    "Observe from this picture drawing?",
    " Create puppets out of socks.",
    "usedifferent types of printings to create a comp[osition",
    "Created a collage with fabrics",
    "Created a collage with fabrics",
    "utilisé du papier mâché pour créer une carotte",
    "Use the Bristol and decorative materials to make other colourful lanterns.",
    "Use paper to do a weaving.",
    " Use the paper loom and weaving template",
    "Decide on a theme for your large scale painting,e.g environment, stories, history etc",
    "Create funny colourful paper toys.",
    "Use the flextangle template",
    "Look at the pattern drawn on the floor.",
    "Express yourself through a picture composition.",
    "decorate the folder where you have kept all work",
    "Produce a composition on the theme ‘Heritage’.",
    "Use paper folding",
    "Use paper folding ",
    "Use the paper batik technique to create a composition on mythology",
    " The image of the solar system",
    "Studying and interpreting visuals can help you to get information about pictures/photos .",
    "Create composition with paper mosaic",
    "Use the template to create paper mosaic",
    "Name the instrument that Emma is playing with.",
    "Draw the alien on page 78",
    "Create artefacts by using objects around you.",
    "create a “maquette” illustrating the different types of land use.",
    "Use the toothbrush and sponge to create your composition."
  ],
  "Performing arts": [
    "Form the shape of a numeral in groups",
    "Make different tableaux",
    "Write a dialogue on the Legend of Lion Mountain ",
    "Draw the encounter between  two animals and write dialogues",
    "Complete the musical pattern: Sa, Re, Ga, Ma, Pa, Dha,  Ni",
    "Let’s practise some musical notes",
    "The “Happy Birthday” Song",
    "Make various poses",
    "Complete the musical pattern: A,B,C,D,E,F,G",
    "Read musical notes",
    "Observe a music pattern.",
    "Say tongue twisters in as many different ways as you can.",
    "Identify  natural rhythms around you. ",
    "Use the emoticons to express your emotions and to show your reactions to different situations.",
    "Steps for creating your stick puppet",
    "Write a story using emoticons",
    "Learning the names of musical notes",
    "Listen to the stories .Mime the action and reproduce the sounds",
    "Learning different notes in a music partition",
    "Sing this song along with your friends.",
    "Vary the pace once  using to the song.",
    "Two-part canon",
    "Three-part canon",
    "Listen to the song.  Learn the song.",
    "Using cardinal directions as hint, jump one step:",
    "Écoute et apprends la chanson",
    "Interpret your friend’s gesture and rearrange the way they both are posing.",
    "Read the poem and discuss it with your friends.",
    "Recall a personal, emotional moment in your life.",
    "learn more about the different festivals.",
    "Listen to the music.",
    "Say  the category of the instrument on p 7  ",
    "Trouve des adjectifs avec les lettres de ton nom.",
    "Nomme un adjectif qui commence par cette lettre.",
    "Use colours to express your emotions.",
    "Listen to these tongue twisters. Repeat after the teacher",
    "Act what is on the paper strip and see how your friend react",
    "Describe the sound characteristics of each instrument.",
    "\r\nEcoute ces virelangues . Répète  après ton enseignant.",
    "Form a tableau showing a situation, for example, a road accident, a scene of the market, a music concert",
    "Observe your friend carefully.",
    "Use the sock puppet to create a character of your choice.",
    "Use you sock puppet to accompany the ‘Old MacDonald has a farm’ song",
    "Observe each gesture that the leader makes and do the same.",
    "The chicken dance song",
    "Dance 'The chicken dance song'",
    "Get ready to show an action by saying the line “let us…”, for example  “let us laugh”",
    "Learn the two songs along with your friends.",
    "Think of a story and write it down using different dialogues.",
    "Create a rhythmic pattern with the activity allocated to your group.",
    "Create a situation and write the dialogues.",
    "Walk around the space.",
    "Listen to this song. Learn the song.",
    "create a choreography that you can use to accompany the song.",
    "Utilise une partie de l’histoire pour créer un tableau vivant",
    "create a character",
    "Use the Information Card to create a character",
    "Create my character information card",
    "Observe the different dance forms./ Observe the movement and the style carefully",
    "Read and Rewrite the story using a dialogue form.",
    "Discuss what you think could be the main facial characteristics of the people in the future",
    "Listen to these tongue twisters.",
    "Learn the three songs along with your friends",
    "Think what scenario or action you can create in your group with the song",
    "Observe the  the musical notes and the numbers",
    "Create an alien /",
    " Observe the pattern of the musical notes",
    "Écoute ces virelangues et redisles avec différentes intonations",
    ...
    "Tell a story based on what you are seeing?",
    "Try to sing each solfège note using the different hand signs",
    "Share the beat"
  ]
}
