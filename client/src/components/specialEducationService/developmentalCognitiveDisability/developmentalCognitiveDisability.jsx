...
const DevelopmentalCognitiveDisability = () => {
  ...
  const {
    data: developmentalCognitiveDisabilitySpecialData,
    error,
    isLoading,
    refetch,
  } = useQuery({
    ...
    queryFn: async () => {
      try {
        const { data: res } = await AxiosConfig.get(
          "/specialeducation/developmentalCognitiveDisability/search",
          {
            params: {
      ...
      try {
        const { data } = await AxiosConfig.post(
          "/specialeducation/developmentalCognitiveDisability",
          {
            ...
            educationService_id: specialData,
            id: developmentalCognitiveDisabilitySpecialData?._id,
          }
        );
  ...
  useEffect(() => {
    console.log(developmentalCognitiveDisabilitySpecialData);
    if (developmentalCognitiveDisabilitySpecialData && !isLoading) {
      console.log({ developmentalCognitiveDisabilitySpecialData });
      setFormData(developmentalCognitiveDisabilitySpecialData);
    } else if (!isLoading) {
...
export default DevelopmentalCognitiveDisability;
