...
const TaumaticBrainInjury = () => {
  ...
  const {
    data: taumaticBrainInjurySpecialData,
    error,
    isLoading,
    refetch,
  } = useQuery({
    ...
    queryFn: async () => {
      try {
        const { data: res } = await AxiosConfig.get(
          "/specialeducation/taumaticBrainInjury/search",
          {
            params: {
      ...
      try {
        const { data } = await AxiosConfig.post(
          "/specialeducation/taumaticBrainInjury",
          {
            ...
            educationService_id: specialData,
            id: taumaticBrainInjurySpecialData?._id,
          }
        );
  ...
  useEffect(() => {
    console.log(taumaticBrainInjurySpecialData);
    if (taumaticBrainInjurySpecialData && !isLoading) {
      console.log({ taumaticBrainInjurySpecialData });
      setFormData(taumaticBrainInjurySpecialData);
    } else if (!isLoading) {
      setFormData(initialData);
    }
  }, [taumaticBrainInjurySpecialData]);
...
export default TaumaticBrainInjury;
