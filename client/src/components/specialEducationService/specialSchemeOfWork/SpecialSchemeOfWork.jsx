...
const SpecialSchemeOfWork = () => {
  ...
  const [selectedPrescribedTextbook, setSelectedPrescribedTextbook] =
    useState(null);
  const [selectedNumberOfPeriodsPerWeek, setSelectedNumberOfPeriodsPerWeek] =
    useState(null);
  ...
  const {
    ...
    queryFn: async ({ queryKey }) => {
      ...
      const response = await AxiosConfig.get(
        "specialeducation/specialschemeofwork/get",
        {
          params: {
  ...
  const createSchemeOfWork = useMutation({
    mutationFn: async (data) => {
      const response = await AxiosConfig.post(
        "specialeducation/specialschemeofwork/create",
        data
      );
      return response.data;
    },
  ...
  const updateSchemeOfWork = useMutation({
    mutationFn: async (data) => {
      const response = await AxiosConfig.put(
        `specialeducation/specialschemeofwork/update/${data?.id}`,
        data?.data
      );
      return response.data;
    },
            ...
            >
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <Select
                              ...
                              isSearchable={false}
                              options={
                                qatLessonPlanThemes2[selectedGrade?.value]
                              }
                            />
                          </td>
                          <td>
              ...
              <div className="d-flex justify-content-center my-2">
                <button
                  ...
                  disabled={
                    createSchemeOfWork.isPending || updateSchemeOfWork.isPending
                  }
                  aria-disabled={
                    createSchemeOfWork.isPending || updateSchemeOfWork.isPending
                  }
