...
const OtherHealthImpairments = () => {
  ...
  const {
    data: otherHealthImpairmentsSpecialData,
    error,
    isLoading,
    refetch,
  } = useQuery({
    ...
    queryFn: async () => {
      try {
        const { data: res } = await AxiosConfig.get(
          "/specialeducation/otherHealthImpairments/search",
          {
            params: {
      ...
      try {
        const { data } = await AxiosConfig.post(
          "/specialeducation/otherHealthImpairments",
          {
            ...
            educationService_id: specialData,
            id: otherHealthImpairmentsSpecialData?._id,
          }
        );
  ...
  useEffect(() => {
    console.log(otherHealthImpairmentsSpecialData);
    if (otherHealthImpairmentsSpecialData && !isLoading) {
      console.log({ otherHealthImpairmentsSpecialData });
      setFormData(otherHealthImpairmentsSpecialData);
    } else if (!isLoading) {
...
export default OtherHealthImpairments;
