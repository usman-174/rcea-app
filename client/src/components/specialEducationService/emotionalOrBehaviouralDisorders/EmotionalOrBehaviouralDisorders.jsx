...
const EmotionalOrBehaviouralDisorders = () => {
  ...
  const {
    data: emotionalOrBehaviouralDisordersSpecialData,
    error,
    isLoading,
    refetch,
  } = useQuery({
    ...
    queryFn: async () => {
      try {
        const { data: res } = await AxiosConfig.get(
          "/specialeducation/emotionalOrBehaviouralDisorders/search",
          {
            params: {
      ...
      try {
        const { data } = await AxiosConfig.post(
          "/specialeducation/emotionalOrBehaviouralDisorders",
          {
            ...
            educationService_id: specialData,
            id: emotionalOrBehaviouralDisordersSpecialData?._id,
          }
        );
  ...
  useEffect(() => {
    console.log(emotionalOrBehaviouralDisordersSpecialData);
    if (emotionalOrBehaviouralDisordersSpecialData && !isLoading) {
      console.log({ emotionalOrBehaviouralDisordersSpecialData });
      setFormData(emotionalOrBehaviouralDisordersSpecialData);
    } else if (!isLoading) {
      setFormData(initialData);
    }
  }, [emotionalOrBehaviouralDisordersSpecialData]);
  return (
...
export default EmotionalOrBehaviouralDisorders;
