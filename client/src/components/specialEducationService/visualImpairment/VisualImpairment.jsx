...
const VisualImpairment = () => {
  ...
  const {
    data: visualImpairmentSpecialData,
    ...
    queryFn: async () => {
      try {
        const { data: res } = await AxiosConfig.get(
          "/specialeducation/visualImpairment/search",
          {
            params: {
      ...
      try {
        const { data } = await AxiosConfig.post(
          "/specialeducation/visualImpairment",
          {
            ...
            educationService_id: specialData,
            id: visualImpairmentSpecialData?._id,
          }
        );
  ...
  useEffect(() => {
    console.log(visualImpairmentSpecialData);
    if (visualImpairmentSpecialData && !isLoading) {
      console.log({ visualImpairmentSpecialData });
      setFormData(visualImpairmentSpecialData);
    } else if (!isLoading) {
