...
const AutismSpectrumDisorder = () => {
  ...
  const {
    data: autismSpectrumDisorderSpecialData,
    error,
    isLoading,
    refetch,
  } = useQuery({
    ...
    queryFn: async () => {
      try {
        const { data: res } = await AxiosConfig.get(
          "/specialeducation/autismSpectrumDisorder/search",
          {
            params: {
      ...
      try {
        const { data } = await AxiosConfig.post(
          "/specialeducation/autismSpectrumDisorder",
          {
            ...
            educationService_id: specialData,
            id: autismSpectrumDisorderSpecialData?._id,
          }
        );
  ...
  useEffect(() => {
    console.log(autismSpectrumDisorderSpecialData);
    if (autismSpectrumDisorderSpecialData && !isLoading) {
      console.log({ autismSpectrumDisorderSpecialData });
      setFormData(autismSpectrumDisorderSpecialData);
    } else if (!isLoading) {
