...
const initialFormData = [{ "skill": "Letter Sound 1", "fluent": "No", "score": 0 },
{ "skill": "Letter Sound 2", "fluent": "No", "score": 0 },
{ "skill": "Letter Sound 3", "fluent": "No", "score": 0 },
{ "skill": "CBC/Blends", "fluent": "No", "score": 0 },
{ "skill": "Magic e", "fluent": "No", "score": 0 },
{ "skill": "Bossy R", "fluent": "No", "score": 0 },
{ "skill": "Vowel Team", "fluent": "No", "score": 0 },
{ "skill": "Suffixes", "fluent": "No", "score": 0 },
{ "skill": "Syllable Division ", "fluent": "No", "score": 0 },
]
const options = [
    { value: "Yes", label: "Yes" },
    { value: "No", label: "No" }
...
// eslint-disable-next-line
    ...
    const {
        ...
        queryFn: async ({ queryKey }) => {
            // eslint-disable-next-line
            const [_, parameters] = queryKey;
            const res = await AxiosConfig.get(`/qps/search`, {
                params: parameters,
            });
            return res.data;
    ...
    const mutation = useMutation({
        mutationFn: async (data) => {
            const response = await AxiosConfig.post("/qps/", data);
            return response.data;
        },
        onSuccess: () => {
    ...
    return (
        <div>
            <Toaster />
            <Container>
                <h2 className="pt-5 mb-4 pb-2">QPS</h2>
                {/* {error && (
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td >
                                                            ...
                                                            <Select
                                                                ...
                                                                id="fluent"
                                                                value={options.find(option => option.value === formData[index]?.fluent)}
                                                                onChange={(selectedOption) => {
                                                                    const newFormData = [...formData];
                                                                    newFormData[index] = {
                                                                        ...newFormData[index],
                                                                        fluent: selectedOption.value
                                                                    };
                                                                    setFormData(newFormData);
                                                                }}
                                                                options={options}
