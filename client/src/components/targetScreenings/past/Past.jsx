...
const initialFormData = [
    ...
    {
        skill: "Deletion-Onset & Rimes",
        item: "level F",
        score: 0,
    },
    {
        skill: "Substitution-Onset & Rimes",
        item: "level G",
        score: 0,
    },
    {
        skill: "Deletion-Blends (1st consonant)",
        item: "level H1",
        score: 0,
    },
    {
        skill: "Substitution-Blends (1st consonant)",
        item: "level H2",
        score: 0,
    },
    {
        skill: "Deletion-final phoneme",
        item: "level I",
        score: 0,
    },
    {
        skill: "Substitution-Vowel sound",
        item: "level J",
        score: 0,
    },
    {
        skill: "Deletion-Blend (2nd consonant)",
        item: "level K1",
        score: 0,
    },
    {
        skill: "Substitution-Blend (2nd consonant)",
        item: "level K2",
        score: 0,
    },
    {
        skill: "Substitution-final sound",
        item: "level L",
        score: 0,
    },
    {
        skill: "eletion-n blend",
        item: "level M1",
        score: 0,
    },
    {
        skill: "Substitution-final blend",
        item: "level M2",
        score: 0,
    }
]
...
const Past = () => {
    ...
    const {
        ...
        queryFn: async ({ queryKey }) => {
            // eslint-disable-next-line
            const [_, parameters] = queryKey;
            const res = await AxiosConfig.get(`/past/search`, {
                params: parameters,
            });
            return res.data;
    ...
    const mutation = useMutation({
        mutationFn: async (data) => {
            const response = await AxiosConfig.post("/past/", data);
            return response.data;
        },
        onSuccess: () => {
